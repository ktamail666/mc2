...
MLRIndexedPrimitive::ClassData* MLRIndexedPrimitive::DefaultData = NULL;

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLRIndexedPrimitive::InitializeClass()
{
    Verify(!DefaultData);
    DefaultData = new ClassData(MLRIndexedPrimitiveClassID, "MidLevelRenderer::MLRIndexedPrimitive", MLRPrimitive::DefaultData, NULL);
    Register_Object(DefaultData);
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLRIndexedPrimitive::TerminateClass()
{
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
MLRIndexedPrimitive::MLRIndexedPrimitive(ClassData* class_data, MemoryStream* stream, int version)
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLRIndexedPrimitive::Save(MemoryStream* stream)
{
    Check_Object(this);
    Check_Object(stream);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLRIndexedPrimitive::TestInstance() const
{
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLRIndexedPrimitive::InitializeDrawPrimitive(int vis, int parameter)
{
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLRIndexedPrimitive::SetCoordData(const Point3D* data, int dataSize)
{
    Check_Object(this);
    Check_Pointer(data);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLRIndexedPrimitive::SetIndexData(unsigned short* index_array, int index_count)
{
    Check_Object(this);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLRIndexedPrimitive::GetIndexData(unsigned short** index_array, int* index_count)
{
    Check_Object(this);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLRIndexedPrimitive::Transform(Matrix4D* mat)
{
    Check_Object(this);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLRIndexedPrimitive::Lighting(MLRLight** lights, int nrLights)
{
    Check_Object(this);
