...
GOSImage* GOSImagePool::GetImage(const char* image_name)
{
    Check_Object(this);
...
GOSImage* GOSImagePool::GetImage(const char* image_name, gos_TextureFormat format, int size, gos_TextureHints hints)
{
    Check_Object(this);
...
bool TGAFilePool::LoadImage(GOSImage* image, int hint)
{
