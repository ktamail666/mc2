...
public:
    ...
    void Load(Stuff::MemoryStream* stream, int version);
...
public:
    ...
    void SetTextureHandle(unsigned texture)
    {
        Check_Object(this);
    ...
    unsigned GetTextureHandle() const
    {
        Check_Object(this);
    ...
    void SetTextureCorrectionOn()
    {
        Check_Object(this);
        renderState |= TextureCorrectionOnMode;
        renderDeltaMask |= TextureCorrectionMask;
    }
    void SetTextureCorrectionOff()
    {
        Check_Object(this);
        renderState &= ~TextureCorrectionOnMode;
        renderDeltaMask |= TextureCorrectionMask;
    }
    TextureCorrectionMode GetTextureCorrectionMode() const
    {
        Check_Object(this);
    ...
    ZBufferCompareMode GetZBufferCompareMode() const
    {
        Check_Object(this);
        return static_cast<ZBufferCompareMode>(renderState & ZBufferCompareMask);
    }

    void SetFlatColoringOn()
    {
        Check_Object(this);
        renderState |= FlatColoringOnMode;
        renderDeltaMask |= FlatColoringMask;
    }
    void SetFlatColoringOff()
    {
        Check_Object(this);
        renderState &= ~FlatColoringOnMode;
        renderDeltaMask |= FlatColoringMask;
    }
    FlatColoringMode GetFlatColoringMode() const
    {
        Check_Object(this);
        return static_cast<FlatColoringMode>(renderState & FlatColoringMask);
    }

    void SetRenderDeltaMask(int mask)
    {
        Check_Object(this);
        renderDeltaMask = mask;
    }

    int GetRenderDeltaMask() const
    {
        Check_Object(this);
        return renderDeltaMask;
    }

    void SetRenderPermissionMask(int mask)
    {
        Check_Object(this);
        renderPermissionMask = mask;
    }

    int GetRenderPermissionMask() const
    {
        Check_Object(this);
        return renderPermissionMask;
    }

    int GetRenderStateFlags() const
    {
        Check_Object(this);
        return renderState;
    }
...
public:
    ...
    BackFaceMode GetBackFaceMode() const
    {
        Check_Object(this);
    ...
    void SetLightingMode(int lighting)
    {
        Check_Object(this);
    ...
    MultiTextureMode GetMultiTextureMode() const
    {
        Check_Object(this);
    ...
    DrawNowMode GetDrawNowMode() const
    {
        Check_Object(this);
        return static_cast<DrawNowMode>(processState & DrawNowOnMode);
    }

    void SetProcessDeltaMask(int mask)
    {
        Check_Object(this);
        processDeltaMask = mask;
    }

    int GetProcessDeltaMask() const
    {
        Check_Object(this);
        return processDeltaMask;
    }

    void SetProcessPermissionMask(int mask)
    {
        Check_Object(this);
        processPermissionMask = mask;
    }

    int GetProcessPermissionMask() const
    {
        Check_Object(this);
        return processPermissionMask;
    }

    int GetProcessStateFlags() const
    {
        Check_Object(this);
        return processState;
    }
    ...
    static bool GetMultitextureLightMap()
    {
        return (systemFlags & CanMultitextureLightMap) > 0;
    }

    static bool GetMultitextureSpecularMap()
    {
        return (systemFlags & CanMultitextureSpecularMap) > 0;
    }

    static bool GetHasMaxUVs()
    {
...
protected:
    int renderState, processState, renderDeltaMask, renderPermissionMask, processDeltaMask, processPermissionMask;

    static int systemFlags;
    static float maxUV;

#ifdef OLDFOG
    unsigned int fogColor;
    Stuff::Scalar fogDensity, nearFog, farFog;
#else
public:
