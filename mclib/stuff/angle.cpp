...
//#############################################################################
//
Radian& Radian::Lerp(const Radian& a, const Radian& b, Scalar t)
{
    Scalar a1, a2;
...
//
#if !defined(Spew)
void Spew(const char* group, const Radian& angle)
{
    Check_Object(&angle);
...
//#############################################################################
//
void Spew(const char* group, const Degree& angle)
{
    Check_Object(&angle);
...
//#############################################################################
//
void Spew(const char* group, const SinCosPair& angle)
{
    Check_Object(&angle);
