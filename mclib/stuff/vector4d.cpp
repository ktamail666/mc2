...
//###########################################################################
//
bool Stuff::Small_Enough(const Vector4D& V, Scalar e)
{
    Check_Object(&V);
...
//###########################################################################
//
bool Stuff::Close_Enough(const Vector4D& V1, const Vector4D& V2, Scalar e)
{
    Check_Object(&V1);
    Check_Object(&V2);
...
//
#if !defined(Spew)
void Spew(const char* group, const Vector4D& vector)
{
    Check_Object(&vector);
...
Vector4D& Vector4D::MultiplySetClip(const Point3D& v, const Matrix4D& m, int* clipper)
{
    Check_Pointer(this);
    Check_Object(&v);
    Check_Object(&m);
