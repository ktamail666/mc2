...
public:
    ...
    //
public:
    void CleanUpAfterCompares();

    bool CompareModificationDate(const MString& file_name, __int64 time_stamp);
    void PurgeFileCompareCache();

    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // Private data
    //
protected:
    typedef Stuff::PlugOf<__int64> FileStatPlug;
