...
#if !defined(Spew)
void Spew(const char* group, const Stuff::Radian& angle);
void Spew(const char* group, const Stuff::Degree& angle);
void Spew(const char* group, const Stuff::SinCosPair& angle);
#endif
...
#if !defined(Spew)
    friend void ::Spew(const char* group, const Radian& angle);
#endif
...
//
#if !defined(Spew)
    friend void ::Spew(const char* group, const Degree& angle);
#endif
    void TestInstance() const
    {
    }
...
//
#if !defined(Spew)
    friend void ::Spew(const char* group, const SinCosPair& angle);
#endif
    void TestInstance() const
    {
    }
...
inline Stuff::MemoryStream& Read(Stuff::MemoryStream* stream, Stuff::Radian* output)
{
    return stream->ReadBytes(output, sizeof(*output));
}
inline Stuff::MemoryStream& Write(Stuff::MemoryStream* stream, const Stuff::Radian* input)
{
