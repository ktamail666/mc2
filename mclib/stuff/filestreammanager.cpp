...
FileDependencies& FileDependencies::operator=(const FileDependencies& dependencies)
{
    ...
    if (len)
    {
        MemoryStream scanner(static_cast<BYTE*>(dependencies.m_fileNameStream.GetPointer()) - len, len);
...
void FileDependencies::AddDependencies(MemoryStream* dependencies)
{
    ...
    {
        const char* new_name = Cast_Pointer(const char*, dependencies->GetPointer());
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
bool FileStreamManager::CompareModificationDate(const MString& file_name, __int64 time_stamp)
{
    Check_Object(this);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void FileStreamManager::PurgeFileCompareCache()
{
    Check_Object(this);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
MString* Stuff::StripExtension(MString* file_name)
{
    Check_Object(file_name);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
MString* Stuff::IsolateDirectory(MString* file_name)
{
    Check_Object(file_name);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
MString* Stuff::StripDirectory(MString* file_name)
{
    PAUSE((""));  // sebi
