...
//###########################################################################
//
void Hash::AddValueImplementation(Plug* plug, const void* value)
{
    Check_Object(this);
    Check_Object(plug);
    Check_Pointer(value);
...
//###########################################################################
//
Plug* Hash::FindImplementation(const void* value)
{
    Check_Object(this);
    Check_Pointer(value);
...
//###########################################################################
//
IteratorPosition Hash::GetHashIndex(const void*)
{
    Check_Object(this);
...
bool Hash::CheckForPrimeSize()
{
    ...
    CollectionSize upper_bound = static_cast<CollectionSize>(Sqrt(static_cast<Scalar>(hashTableSize)));
...
//###########################################################################
//
Plug* HashIterator::FindImplementation(const void*)
{
    Check_Object(this);
    STOP(("Not implemented"));
    return NULL;
...
//###########################################################################
//
void HashIterator::ReceiveMemo(IteratorMemo, void*)
{
    Check_Object(this);
}
