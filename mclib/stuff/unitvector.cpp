...
//###########################################################################
//
bool Stuff::Close_Enough(const UnitVector3D& V1, const UnitVector3D& V2, Scalar e)
{
    Check_Object(&V1);
    Check_Object(&V2);
    UnitVector3D v(V1.x - V2.x, V1.y - V2.y, V1.z - V2.z);
...
//#############################################################################
//
UnitVector3D& UnitVector3D::Lerp(const UnitVector3D& v1, const UnitVector3D& v2, Scalar t)
{
    Check_Pointer(this);
    Check_Object(&v1);
    Check_Object(&v2);
...
//#############################################################################
//
void UnitVector3D::TestInstance() const
{
#ifdef _ARMOR
