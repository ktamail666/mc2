...
static bool __stdcall Check_UseFastLerp()
{
    return UseFastLerp == true;
}
static bool __stdcall Check_UseFastNormalize()
{
    return UseFastNormalize == true;
}


static void __stdcall Activate_UseFastLerp()
{
    UseFastLerp = !UseFastLerp;
}
static void __stdcall Activate_UseFastNormalize()
{
...
//#############################################################################
//
bool Stuff::Small_Enough(const EulerAngles& angles, Scalar e)
{
    Check_Object(&angles);
...
//#############################################################################
//
bool Stuff::Close_Enough(const EulerAngles& a1, const EulerAngles& a2, Scalar e)
{
    Check_Object(&a1);
    Check_Object(&a2);
...
//#############################################################################
//
EulerAngles& EulerAngles::Lerp(const EulerAngles& a1, const EulerAngles& a2, Scalar t)
{
    Check_Pointer(this);
    Check_Object(&a1);
    Check_Object(&a2);
...
//
#if !defined(Spew)
void Spew(const char* group, const EulerAngles& angle)
{
    Check_Object(&angle);
    SPEW((group, "<+"));
...
YawPitchRoll& YawPitchRoll::operator=(const LinearMatrix4D& matrix)
{
    ...
    else
    {
        ...
        Verify(Close_Enough(y.cosine * r.cosine + p.sine * y.sine * r.sine, matrix(0, 0), 1e-4f));
    }
...
//#############################################################################
//
bool Stuff::Small_Enough(const YawPitchRoll& angles, Scalar e)
{
    Check_Object(&angles);
...
//#############################################################################
//
bool Stuff::Close_Enough(const YawPitchRoll& a1, const YawPitchRoll& a2, Scalar e)
{
    Check_Object(&a1);
    Check_Object(&a2);
...
//#############################################################################
//
YawPitchRoll& YawPitchRoll::Lerp(const YawPitchRoll& a1, const YawPitchRoll& a2, Scalar t)
{
    Check_Pointer(this);
    Check_Object(&a1);
    Check_Object(&a2);
...
//
#if !defined(Spew)
void Spew(const char* group, const YawPitchRoll& angle)
{
    Check_Object(&angle);
...
//#############################################################################
//
bool Stuff::Close_Enough(const UnitQuaternion& a1, const UnitQuaternion& a2, Scalar e)
{
    Check_Object(&a1);
    Check_Object(&a2);
...
//#############################################################################
//
Scalar UnitQuaternion::GetAngle()
{
    Check_Object(this);
...
//#############################################################################
//
UnitQuaternion& UnitQuaternion::Multiply(const UnitQuaternion& q, Scalar t)
{
    Check_Pointer(this);
    Check_Object(&q);
...
//#############################################################################
//
UnitQuaternion& UnitQuaternion::MultiplyScaled(const UnitQuaternion& q1, const UnitQuaternion& q2, Scalar t)
{
    Check_Pointer(this);
    Verify(this != &q1);
    Check_Object(&q1);
...
//#############################################################################
//
UnitQuaternion& UnitQuaternion::Lerp(const EulerAngles& v1, const EulerAngles& v2, Scalar t)
{
    UnitQuaternion q1;
    q1 = v1;
    UnitQuaternion q2;
...
UnitQuaternion& UnitQuaternion::FastLerp(const UnitQuaternion& p, const UnitQuaternion& q, Scalar t)
{
    if (!UseFastLerp)
        return Lerp(p, q, t);
...
//#############################################################################
//
UnitQuaternion UnitQuaternion::SquadRev(
...
//#############################################################################
//
Scalar UnitQuaternion::Dot(const UnitQuaternion& p, const UnitQuaternion& q)
{
...
//#############################################################################
//
UnitQuaternion UnitQuaternion::CompA(const UnitQuaternion& qprev, const UnitQuaternion& q, const UnitQuaternion& qnext)
{
...
//
#if !defined(Spew)
void Spew(const char* group, const UnitQuaternion& quat)
{
    Check_Object(&quat);
...
//#############################################################################
//
void UnitQuaternion::TestInstance() const
{
