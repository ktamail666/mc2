...
#if !defined(Spew)
void Spew(const char* group, const Stuff::EulerAngles& angle);
void Spew(const char* group, const Stuff::YawPitchRoll& angle);
void Spew(const char* group, const Stuff::UnitQuaternion& angle);
#endif
...
#if !defined(Spew)
    friend void ::Spew(const char* group, const EulerAngles& angle);
#endif
...
public:
    ...
    // Template support
    //
    YawPitchRoll& Lerp(const YawPitchRoll& v1, const YawPitchRoll& v2, Scalar t);
...
#if !defined(Spew)
    friend void ::Spew(const char* group, const YawPitchRoll& angle);
#endif
...
public:
    ...
    UnitQuaternion(Scalar x, Scalar y, Scalar z, Scalar w)
    {
        Check_Pointer(this);
        this->x = x;
        this->y = y;
    ...
    // "Close-enough" comparators
    //
    friend bool Small_Enough(const UnitQuaternion& q, Scalar e = SMALL)
    {
        Check_Object(&q);
    ...
    UnitQuaternion& Multiply(const UnitQuaternion& q, Scalar scale);
    UnitQuaternion& MultiplyScaled(const UnitQuaternion& q1, const UnitQuaternion& q2, Scalar t);
    ...
    UnitQuaternion& Lerp(const UnitQuaternion& p, const UnitQuaternion& q, Scalar t);

    UnitQuaternion& FastLerp(const UnitQuaternion& p, const UnitQuaternion& q, Scalar t);


    UnitQuaternion& Lerp(const EulerAngles& v1, const EulerAngles& v2, Scalar t);
    ...
    Scalar Dot(const UnitQuaternion& p, const UnitQuaternion& q);
    ...
    UnitQuaternion CompA(const UnitQuaternion& qprev, const UnitQuaternion& q, const UnitQuaternion& qnext);
...
//
#if !defined(Spew)
    friend void ::Spew(const char* group, const UnitQuaternion& quat);
#endif
    void TestInstance() const;
    static bool TestClass();
};
...
inline Stuff::MemoryStream& Read(Stuff::MemoryStream* stream, Stuff::EulerAngles* output)
{
    return stream->ReadBytes(output, sizeof(*output));
}
inline Stuff::MemoryStream& Write(Stuff::MemoryStream* stream, const Stuff::EulerAngles* input)
{
    return stream->WriteBytes(input, sizeof(*input));
}

inline Stuff::MemoryStream& Read(Stuff::MemoryStream* stream, Stuff::YawPitchRoll* output)
{
    return stream->ReadBytes(output, sizeof(*output));
}
inline Stuff::MemoryStream& Write(Stuff::MemoryStream* stream, const Stuff::YawPitchRoll* input)
{
    return stream->WriteBytes(input, sizeof(*input));
}

inline Stuff::MemoryStream& Read(Stuff::MemoryStream* stream, Stuff::UnitQuaternion* output)
{
    return stream->ReadBytes(output, sizeof(*output));
}
inline Stuff::MemoryStream& Write(Stuff::MemoryStream* stream, const Stuff::UnitQuaternion* input)
{
    return stream->WriteBytes(input, sizeof(*input));
}
