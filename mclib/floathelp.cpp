...
//-----------------------------------------------------------------------------------------
void FloatHelp::setFloatHelp(char* txt, Stuff::Vector4D screenPos, DWORD fClr, DWORD bClr, float scl, bool proportional, bool bold, bool italic, bool wordWrap)
{
...
//-----------------------------------------------------------------------------------------
void FloatHelp::getTextStringLength(char* txt, DWORD fColor, float scl, bool proportional, bool bold, bool italic, bool wordWrap, DWORD& width, DWORD& height)
{
