...
{
    return SubString(m_pBuffer->m_Data_Length - Num_Chars, m_pBuffer->m_Data_Length - 1);
}
...
/////////////////////////////////////////////////////////////////
inline bool operator<(const EChar* p_Lesser_String, const EString& Greater_String)
{
...
/////////////////////////////////////////////////////////////////
inline bool operator>(const EChar* p_Greater_String, const EString& Lesser_String)
{
