...
class Singleton__Specification : public Effect__Specification
{
    ...
    //
protected:
    Singleton__Specification(Stuff::RegisteredClass::ClassID class_id, Stuff::MemoryStream* stream, int gfx_version);
...
public:
    ...
    //
public:
    SeededCurveOf<ComplexCurve, LinearCurve, Curve::e_ComplexLinearType> m_red, m_green, m_blue, m_alpha;
...
protected:
    ...
    Singleton(ClassData* class_data, Specification* spec, unsigned flags);
