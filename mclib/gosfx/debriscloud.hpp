...
class DebrisCloud__Specification : public Effect__Specification
{
    ...
    //
protected:
    DebrisCloud__Specification(Stuff::MemoryStream* stream, int gfx_version);
...
public:
    ...
    static DebrisCloud__Specification* Make(Stuff::MemoryStream* stream, int gfx_version);
...
public:
    ...
    Stuff::DynamicArrayOf<Stuff::Scalar> debrisSeed;
};
...
public:
    ...
    //
protected:
    DebrisCloud(Specification* spec, unsigned flags);

public:
    static DebrisCloud* Make(Specification* spec, unsigned flags);
...
protected:
    ...
    bool AnimateParticle(unsigned index, const Stuff::LinearMatrix4D* world_to_new_local, Stuff::Time till);
    virtual void DestroyParticle(unsigned index);
    void ComputeNewLinearVelocity(Particle* particle, Stuff::Scalar time_slice);
