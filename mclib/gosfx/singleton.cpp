...
//------------------------------------------------------------------------------
//
gosFX::Singleton__Specification::Singleton__Specification(Stuff::RegisteredClass::ClassID class_id, Stuff::MemoryStream* stream, int gfx_version)
...
gosFX::Singleton::ClassData* gosFX::Singleton::DefaultData = NULL;
...
void gosFX::Singleton::InitializeClass()
{
    Verify(!DefaultData);
    Verify(gos_GetCurrentHeap() == Heap);
    DefaultData = new ClassData(SingletonClassID, "gosFX::Singleton", Effect::DefaultData, NULL, NULL);
...
//------------------------------------------------------------------------------
//
gosFX::Singleton::Singleton(ClassData* class_data, Specification* spec, unsigned flags)
...
//------------------------------------------------------------------------------
//
void gosFX::Singleton::TestInstance() const
{
