...
//------------------------------------------------------------------------------
//
gosFX::DebrisCloud__Specification::DebrisCloud__Specification(Stuff::MemoryStream* stream, int gfx_version)
...
//------------------------------------------------------------------------------
//
gosFX::DebrisCloud__Specification* gosFX::DebrisCloud__Specification::Make(Stuff::MemoryStream* stream, int gfx_version)
{
    Check_Object(stream);
...
//------------------------------------------------------------------------------
//
void gosFX::DebrisCloud__Specification::LoadGeometry(Stuff::MemoryStream* stream)
{
...
gosFX::DebrisCloud::ClassData* gosFX::DebrisCloud::DefaultData = NULL;
...
void gosFX::DebrisCloud::InitializeClass()
{
    ...
    Verify(gos_GetCurrentHeap() == Heap);
    DefaultData =
        new ClassData(DebrisCloudClassID, "gosFX::DebrisCloud", EffectCloud::DefaultData, (Effect::Factory)&Make, (Specification::Factory)&Specification::Make);
...
//------------------------------------------------------------------------------
//
gosFX::DebrisCloud::DebrisCloud(Specification* spec, unsigned flags)
...
//------------------------------------------------------------------------------
//
gosFX::DebrisCloud* gosFX::DebrisCloud::Make(Specification* spec, unsigned flags)
{
    Check_Object(spec);
...
void gosFX::DebrisCloud::Start(struct gosFX::Effect::ExecuteInfo* info)
{
    ...
    for (i = 0; i < numOfParticles; i++)
    {
        ...
        Stuff::Scalar lifetime = spec->m_pLifeSpan.ComputeValue(0.0f, particle->m_seed);
        ...
        Stuff::Scalar lerpFactor = Stuff::Lerp(
            spec->m_minimumDeviation.ComputeValue(0.0f, particle->m_seed), spec->m_maximumDeviation.ComputeValue(0.0f, particle->m_seed),
...
//------------------------------------------------------------------------------
//
bool gosFX::DebrisCloud::AnimateParticle(unsigned index, const Stuff::LinearMatrix4D* world_to_new_local, Stuff::Time till)
{
    Check_Object(this);
    ...
    //-------------------------------------------------
    //
    Stuff::Scalar time_slice = static_cast<Stuff::Scalar>(till - m_lastRan);
...
//------------------------------------------------------------------------------
//
void gosFX::DebrisCloud::DestroyParticle(unsigned int index)
{
    Particle* particle = GetParticle(index);
    Check_Object(particle);
    particle->m_age = 1.0f;
...
//------------------------------------------------------------------------------
//
void gosFX::DebrisCloud::TestInstance() const
{
