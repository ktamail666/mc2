...
TokenCodeType followVarBlockList[] = { TKN_FUNCTION, TKN_ORDER, TKN_STATE, TKN_CODE, TKN_EOF, TKN_NONE };
...
TokenCodeType followIndexesList[] = { TKN_OF, TKN_IDENTIFIER, TKN_LPAREN, TKN_PLUS, TKN_MINUS, TKN_NUMBER, TKN_SEMICOLON, TKN_EOF, TKN_NONE };
...
{
    varOrFieldDeclarations(routineIdPtr, STACK_FRAME_HEADER_SIZE + routineIdPtr->defn.info.routine.paramCount);
}
