...
void ABLi_init(
    ...
    long (*fileWriteIntCB)(void* file, int32_t value),
...
long ABLi_execute(SymTableNodePtr moduleIdPtr, SymTableNodePtr functionIdPtr = NULL, ABLParamPtr paramList = NULL, StackItemPtr returnVal = NULL);
...
void ABLi_addFunction(const char* name, bool isOrder, const char* paramList, const char* returnType, void (*codeCallback)(void));

void ABLi_setRandomCallbacks(void (*seedRandomCallback)(unsigned long seed), long (*randomCallback)(long range));
