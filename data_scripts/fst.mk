...
art.fst:
	$(MC2_BIN)/makefst -f art.fst -p $(SRC_DATA_ROOT)/art/ -m data/art

mission.fst: $(SRC_DATA_ROOT)/missions.rsp
	$(MC2_BIN)/makefst -f mission.fst -p $(SRC_DATA_ROOT) -rsp $(SRC_DATA_ROOT)/missions.rsp -m data

camera.fst:
	$(MC2_BIN)/makefst -f camera.fst -p $(SRC_DATA_ROOT)/cameras/ -m data/cameras

effect.fst:
	$(MC2_BIN)/makefst -f effect.fst -p $(SRC_DATA_ROOT)/effects/ -m data/effects
...
textures.fst:
	$(MC2_BIN)/makefst -f textures.fst -p $(SRC_DATA_ROOT)/textures/ -m data/textures
