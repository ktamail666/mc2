...
$(FONTS_OUTPUT)$(PATH_SEPARATOR)arial8.bmp: $(SRC_DATA_ROOT)/fonts/emulogic.ttf
	$(MC2_BIN)/text_tool $(SRC_DATA_ROOT)/fonts/emulogic.ttf 8 $(FONTS_OUTPUT)/arial8

$(FONTS_OUTPUT)$(PATH_SEPARATOR)arial9game.bmp: $(SRC_DATA_ROOT)/fonts/emulogic.ttf
	$(MC2_BIN)/text_tool $(SRC_DATA_ROOT)/fonts/emulogic.ttf 8 $(FONTS_OUTPUT)/arial9game

$(FONTS_OUTPUT)$(PATH_SEPARATOR)arial9chat.bmp: $(SRC_DATA_ROOT)/fonts/emulogic.ttf
	$(MC2_BIN)/text_tool $(SRC_DATA_ROOT)/fonts/emulogic.ttf 8 $(FONTS_OUTPUT)/arial9chat

$(FONTS_OUTPUT)$(PATH_SEPARATOR)arialnarrow8.bmp: $(SRC_DATA_ROOT)/fonts/emulogic.ttf
	$(MC2_BIN)/text_tool $(SRC_DATA_ROOT)/fonts/emulogic.ttf 8 $(FONTS_OUTPUT)/arialnarrow8

$(FONTS_OUTPUT)$(PATH_SEPARATOR)arialnarrow9.bmp: $(SRC_DATA_ROOT)/fonts/emulogic.ttf
	$(MC2_BIN)/text_tool $(SRC_DATA_ROOT)/fonts/emulogic.ttf 8 $(FONTS_OUTPUT)/arialnarrow9

$(FONTS_OUTPUT)$(PATH_SEPARATOR)arialblack9.bmp: $(SRC_DATA_ROOT)/fonts/emulogic.ttf
	$(MC2_BIN)/text_tool $(SRC_DATA_ROOT)/fonts/emulogic.ttf 8 $(FONTS_OUTPUT)/arialblack9



$(FONTS_OUTPUT)$(PATH_SEPARATOR)agencyfb8.bmp: $(SRC_DATA_ROOT)/fonts/emulogic.ttf
	$(MC2_BIN)/text_tool $(SRC_DATA_ROOT)/fonts/emulogic.ttf 8 $(FONTS_OUTPUT)/agencyfb8

$(FONTS_OUTPUT)$(PATH_SEPARATOR)agencyfb11.bmp: $(SRC_DATA_ROOT)/fonts/emulogic.ttf
	$(MC2_BIN)/text_tool $(SRC_DATA_ROOT)/fonts/emulogic.ttf 8 $(FONTS_OUTPUT)/agencyfb11



$(FONTS_OUTPUT)$(PATH_SEPARATOR)agencyfb14.bmp: $(SRC_DATA_ROOT)/fonts/Mecha.ttf
	$(MC2_BIN)/text_tool $(SRC_DATA_ROOT)/fonts/Mecha.ttf 14 $(FONTS_OUTPUT)/agencyfb14

$(FONTS_OUTPUT)$(PATH_SEPARATOR)agencyfb17.bmp: $(SRC_DATA_ROOT)/fonts/Mecha.ttf
	$(MC2_BIN)/text_tool $(SRC_DATA_ROOT)/fonts/Mecha.ttf 14 $(FONTS_OUTPUT)/agencyfb17

$(FONTS_OUTPUT)$(PATH_SEPARATOR)agencyfb20.bmp: $(SRC_DATA_ROOT)/fonts/Mecha.ttf
	$(MC2_BIN)/text_tool $(SRC_DATA_ROOT)/fonts/Mecha.ttf 14 $(FONTS_OUTPUT)/agencyfb20


$(FONTS_OUTPUT)$(PATH_SEPARATOR)arialnarrow6.bmp: $(SRC_DATA_ROOT)/fonts/6px2bus.ttf
	$(MC2_BIN)/text_tool $(SRC_DATA_ROOT)/fonts/6px2bus.ttf 6 $(FONTS_OUTPUT)/arialnarrow6
