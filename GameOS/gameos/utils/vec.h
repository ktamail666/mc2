...
struct mat3
{
    ...
    vec3& getRow(const unsigned int index)
    {
        return *((vec3*)elem[index]);
    }
...
struct mat4
{
    ...
    {
        return vec3(elem[0][0], elem[0][1], elem[0][2]);
    }
    vec3 getUpVec() const
    {
        return vec3(elem[1][0], elem[1][1], elem[1][2]);
    }
    vec3 getForwardVec() const
    {
        return vec3(elem[2][0], elem[2][1], elem[2][2]);
    }
    ...
    void setElem(int c, int r, float el)
    {
        elem[r][c] = el;
    }
    float getElem(int c, int r) const
    {
        return elem[r][c];
    }
    ...
    {
        return vec3(elem[0][3], elem[1][3], elem[2][3]);
    }
    void setTranslation(const vec3& tr)
    {
        setCol3(vec4(tr.x, tr.y, tr.z, elem[3][3]));
    }
};
