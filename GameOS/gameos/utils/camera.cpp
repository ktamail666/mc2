...
void camera::set_projection(const mat4& proj)
{
    ...
    mat4 invProj(inv[0], inv[1], inv[2], inv[3], inv[4], inv[5], inv[6], inv[7], inv[8], inv[9], inv[10], inv[11], inv[12], inv[13], inv[14], inv[15]);
...
void camera::update(float dt)
{
    ...
    mat4 invView(inv[0], inv[1], inv[2], inv[3], inv[4], inv[5], inv[6], inv[7], inv[8], inv[9], inv[10], inv[11], inv[12], inv[13], inv[14], inv[15]);
    inv_view_ = invView;
