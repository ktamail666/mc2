...
#include <SDL2/SDL.h>  // can avoid including this here if move MouseInfo struct to separate file
...
gosEnum_KeyIndex remap_sdl_to_gos(const SDL_Scancode scancode)
{
    ...
    switch (scancode)
    {
        ...
        case SDL_SCANCODE_LANG2:
            return KEY_KANJI;  // is it correct?
...
const char* __stdcall gos_DescribeKey(DWORD Key)
{
    ...
    DWORD ascii   = Key & 0xFF;
    (void)ascii;  // may be 0 if extended key
