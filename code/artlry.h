...
public:
    ...
    void build(long commanderId, long strikeType, Stuff::Vector3D location, long seconds);
...
//---------------------------------------------------------------------------
extern void CallArtillery(long commanderId, long strikeType, Stuff::Vector3D strikeLoc, long secondsToImpact, bool randomOffset);

extern void IfaceCallStrike(
    long strikeID,
