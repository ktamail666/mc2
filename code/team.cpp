...
bool Team::teamLineOfSight(Stuff::Vector3D tPos, float extRad)
{
    ...
    {
        if (ObjectManager->specialBuildings[spBuilding] && ObjectManager->specialBuildings[spBuilding]->getExists()
            && ObjectManager->specialBuildings[spBuilding]->isLookoutTower() && (ObjectManager->specialBuildings[spBuilding]->getTeamId() == id))
        {
