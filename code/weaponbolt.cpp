        ...
        if (!((WeaponBoltTypePtr)getObjectType())->isBeam)
        {
            ...
            if (lastDistanceMoved >= distance)
            {
                ...
                if (target)
                {
                    ...
                    if (((WeaponBoltTypePtr)getObjectType())->hitEffectObjNum && (((WeaponBoltTypePtr)getObjectType())->areaEffectDmg > 0.0f)
                        && (((WeaponBoltTypePtr)getObjectType())->areaEffectRad > 0.0f))
                    {
                        ...
                        ObjectManager->createExplosion(
                            ((WeaponBoltTypePtr)getObjectType())->hitEffectObjNum, NULL, *targetPosition, ((WeaponBoltTypePtr)getObjectType())->areaEffectDmg,
...
void WeaponBolt::render(void)
{
    if (!getFlag(OBJECT_FLAG_JUSTCREATED) && !isTargeted())  //can we be seen by the enemy?
    {
        ...
        if (!gosEffect && !hitTarget && !((WeaponBoltTypePtr)getObjectType())->isBeam)
        {
            ...
            if (((lq1Vertices[0].x > eye->viewMulX) || (lq1Vertices[0].y > eye->viewMulY) || (lq1Vertices[0].x < eye->viewAddX)
                 || (lq1Vertices[0].y < eye->viewAddY) || (lq1Vertices[1].x > eye->viewMulX) || (lq1Vertices[1].y > eye->viewMulY)
                 || (lq1Vertices[1].x < eye->viewAddX) || (lq1Vertices[1].y < eye->viewAddY) || (lq1Vertices[2].x > eye->viewMulX)
                 || (lq1Vertices[2].y > eye->viewMulY) || (lq1Vertices[2].x < eye->viewAddX) || (lq1Vertices[2].y < eye->viewAddY)))
            {
            }
            else
            {
            ...
            if (((lq2Vertices[0].x > eye->viewMulX) || (lq2Vertices[0].y > eye->viewMulY) || (lq2Vertices[0].x < eye->viewAddX)
                 || (lq2Vertices[0].y < eye->viewAddY) || (lq2Vertices[1].x > eye->viewMulX) || (lq2Vertices[1].y > eye->viewMulY)
                 || (lq2Vertices[1].x < eye->viewAddX) || (lq2Vertices[1].y < eye->viewAddY) || (lq2Vertices[2].x > eye->viewMulX)
                 || (lq2Vertices[2].y > eye->viewMulY) || (lq2Vertices[2].x < eye->viewAddX) || (lq2Vertices[2].y < eye->viewAddY)))
            {
            }
            else
            {
            ...
            if (((lq3Vertices[0].x > eye->viewMulX) || (lq3Vertices[0].y > eye->viewMulY) || (lq3Vertices[0].x < eye->viewAddX)
                 || (lq3Vertices[0].y < eye->viewAddY) || (lq3Vertices[1].x > eye->viewMulX) || (lq3Vertices[1].y > eye->viewMulY)
                 || (lq3Vertices[1].x < eye->viewAddX) || (lq3Vertices[1].y < eye->viewAddY) || (lq3Vertices[2].x > eye->viewMulX)
                 || (lq3Vertices[2].y > eye->viewMulY) || (lq3Vertices[2].x < eye->viewAddX) || (lq3Vertices[2].y < eye->viewAddY)))
            {
            }
            else
            {
            ...
            if (((lq4Vertices[0].x > eye->viewMulX) || (lq4Vertices[0].y > eye->viewMulY) || (lq4Vertices[0].x < eye->viewAddX)
                 || (lq4Vertices[0].y < eye->viewAddY) || (lq4Vertices[1].x > eye->viewMulX) || (lq4Vertices[1].y > eye->viewMulY)
                 || (lq4Vertices[1].x < eye->viewAddX) || (lq4Vertices[1].y < eye->viewAddY) || (lq4Vertices[2].x > eye->viewMulX)
                 || (lq4Vertices[2].y > eye->viewMulY) || (lq4Vertices[2].x < eye->viewAddX) || (lq4Vertices[2].y < eye->viewAddY)))
            {
            }
            else
            {
        ...
        else if (!hitTarget && ((WeaponBoltTypePtr)getObjectType())->isBeam)
        {
            ...
            {
                if ((lq1Vertices[0].z >= 0.0f) && (lq1Vertices[0].z < 1.0f) && (lq1Vertices[1].z >= 0.0f) && (lq1Vertices[1].z < 1.0f)
                ...
                if ((lq2Vertices[0].z >= 0.0f) && (lq2Vertices[0].z < 1.0f) && (lq2Vertices[1].z >= 0.0f) && (lq2Vertices[1].z < 1.0f)
                ...
                if ((lq3Vertices[0].z >= 0.0f) && (lq3Vertices[0].z < 1.0f) && (lq3Vertices[1].z >= 0.0f) && (lq3Vertices[1].z < 1.0f)
                ...
                if ((lq4Vertices[0].z >= 0.0f) && (lq4Vertices[0].z < 1.0f) && (lq4Vertices[1].z >= 0.0f) && (lq4Vertices[1].z < 1.0f)
