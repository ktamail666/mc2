...
Stuff::Vector3D pos[36] = { Stuff::Vector3D(-3400.0f, 3000.0f, -1.0f), Stuff::Vector3D(-3300.0f, 2700.0f, -1.0f), Stuff::Vector3D(-3300.0f, 2800.0f, -1.0f),
                            Stuff::Vector3D(-3300.0f, 2900.0f, -1.0f), Stuff::Vector3D(-3300.0f, 3000.0f, -1.0f), Stuff::Vector3D(-3200.0f, 2700.0f, -1.0f),
                            Stuff::Vector3D(-3200.0f, 2800.0f, -1.0f), Stuff::Vector3D(-3200.0f, 2900.0f, -1.0f), Stuff::Vector3D(-3200.0f, 3000.0f, -1.0f),
                            Stuff::Vector3D(-3100.0f, 2700.0f, -1.0f), Stuff::Vector3D(-3100.0f, 2800.0f, -1.0f), Stuff::Vector3D(-3100.0f, 2900.0f, -1.0f),
                            Stuff::Vector3D(-3100.0f, 3000.0f, -1.0f), Stuff::Vector3D(-3000.0f, 2700.0f, -1.0f), Stuff::Vector3D(-3000.0f, 2800.0f, -1.0f),
                            Stuff::Vector3D(-3000.0f, 2900.0f, -1.0f), Stuff::Vector3D(-3000.0f, 3000.0f, -1.0f), Stuff::Vector3D(-2900.0f, 2700.0f, -1.0f),
                            Stuff::Vector3D(-2900.0f, 2800.0f, -1.0f), Stuff::Vector3D(-2900.0f, 2900.0f, -1.0f), Stuff::Vector3D(-2900.0f, 3000.0f, -1.0f),
                            Stuff::Vector3D(-2800.0f, 2700.0f, -1.0f), Stuff::Vector3D(-2800.0f, 2800.0f, -1.0f), Stuff::Vector3D(-2800.0f, 2900.0f, -1.0f),
                            Stuff::Vector3D(-2800.0f, 3000.0f, -1.0f), Stuff::Vector3D(-2700.0f, 2700.0f, -1.0f), Stuff::Vector3D(-2700.0f, 2800.0f, -1.0f),
                            Stuff::Vector3D(-2700.0f, 2900.0f, -1.0f), Stuff::Vector3D(-2700.0f, 3000.0f, -1.0f), Stuff::Vector3D(-2600.0f, 2700.0f, -1.0f),
                            Stuff::Vector3D(-2600.0f, 2800.0f, -1.0f), Stuff::Vector3D(-2600.0f, 2900.0f, -1.0f), Stuff::Vector3D(-2600.0f, 3000.0f, -1.0f),
                            Stuff::Vector3D(-2500.0f, 2700.0f, -1.0f), Stuff::Vector3D(-2500.0f, 2800.0f, -1.0f), Stuff::Vector3D(-2500.0f, 2900.0f, -1.0f) };
...
void DEBUGWINS_renderSpecialWindows()
{
        ...
        if (MPlayer)
        {
            ...
            for (int i = 0; i < MAX_MC_PLAYERS; i++)
            {
                if (MPlayer->playerInfo[i].commanderID > -1)
                {
                    char s[256];
                    sprintf(
                        s, "Player %d (%s) score = %d, %d kills, %d losses", i, MPlayer->playerInfo[i].name, MPlayer->playerInfo[i].score,
...
void __stdcall InitializeGameEngine()
{
    ...
    if (driveSpace < (20 * 1024 * 1024))
    {
        ...
        DWORD result = MessageBox(nullptr, msg, title, MB_OKCANCEL | MB_ICONWARNING);
        if (result == IDCANCEL)
        {
            ExitGameOS();
        }
    ...
    {
        CopyFile("hiprefs.cfg", "orgprefs.cfg", true);
        CopyFile("hiprefs.cfg", "options.cfg", true);
    }
...

    {
		...
		*/
        ...
        auto* pool                                 = new MidLevelRenderer::TGAFilePool("data" PATH_SEPARATOR "tgl" PATH_SEPARATOR "128" PATH_SEPARATOR);
        ...
        globalWindow->buffer =
            nullptr;  //This is set at the start of Renders.  For now we HOLD LOCK during entire old 2D render test.  This will go away once we hit 3D
        ...
        if (justStartMission)
        {
            ...
            char commandersToLoad[MAX_MC_PLAYERS][3] = {
                { 0, 0, 0 }, { 1, 1, 1 }, { 2, 0, 2 }, { 3, 3, 3 }, { 4, 4, 4 }, { 5, 5, 5 }, { 6, 6, 6 }, { 7, 7, 7 }
            };
...
void __stdcall GetGameOSEnvironment(const char* CommandLine)
{
    ...
    Environment.Suppress3DFullScreenWarning = true;

    Environment.RenderToVram = true;
