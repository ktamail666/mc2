...
public:
    ...
    aAnimTextListItem(long fontResID)
...
public:
    ...
    void setHiddenText(const char* pText)
    {
        hiddenText = pText;
    }
    const char* getHiddenText() const
    {
        return hiddenText;
    }
...
public:
    ...
    void setSpaceBetweenItems(long newSpace)
    {
        skipAmount = newSpace;
    }
    long getSpaceBetweenItems()
    {
        return skipAmount;
    }
    ...
    void setPressFX(int newFX)
    {
        clickSFX = newFX;
    }
    void setHighlightFX(int newFX)
    {
        highlightSFX = newFX;
    }
    void setDisabledFX(int newFX)
    {
        disabledSFX = newFX;
    }

    void setTopSkip(long newSkip)
    {
        topSkip = newSkip;
    }
